...
class Mensajes():
  ...
  def mensaje(self,v1,v2,v3,v4,v1A,v1B,v2A,v2B,v3A,v3B,v4A,v4B):
    ...
    text5 = font.render("Velocidad1_canalA (pps): "+str(v1A), True, color)
    text6 = font.render("Velocidad1_canalB (pps): "+str(v1B), True, color)
    text7 = font.render("Velocidad2_canalA (pps): "+str(v2A), True, color)
    text8 = font.render("Velocidad2_canalB (pps): "+str(v2B), True, color)
    text9 = font.render("Velocidad3_canalA (pps): "+str(v3A), True, color)
    text10 = font.render("Velocidad3_canalB (pps): "+str(v3B), True, color)
    text11 = font.render("Velocidad4_canalA (pps): "+str(v4A), True, color)
    text12 = font.render("Velocidad4_canalB (pps): "+str(v4B), True, color)
